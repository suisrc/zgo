...
-- INSERT INTO `zgo_oauth2_account`(`id`, `account_id`, `client_id`, `user_kid`, `role_kid`, `expired`, `last_ip`, `last_at`, `limit_exp`, `limit_key`, `mode`, `secret`, `status`, `creator`, `created_at`, `updated_at`, `version`) VALUES ();
