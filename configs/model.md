...
服务是平台提供的服务入口， 与client是多对一关系， 一个服务分裂出多个client为不同的租户提供服务， 但是他们之间只是通过app_service_audience中的audience
形成关联关系
...
| id            | 唯一标识       | 数值     |                                                     | int(11) NOT NULL AUTO_INCREMENT, primary             |
| ------------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| name          | 服务名称       | 字符串   |                                                     | varchar(64), udx_app_service_name                    |
...
| 字段          | 中文说明       | 字段类型 | 备注                                                | MYSQL                                                |
| ------------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| token_kid     | 角色标识       | 字符串   |                                                     | varchar(64), udx_token_kid                           |
| account_id    | 令牌归属       | 数值     |                                                     | int(11), idx_token_account_id                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| access_token    | 访问令牌     | 字符串   |                                                     | varchar(4096)                                        |
| expires_at      | 访问令牌     | 数值     |                                                     | int(11) DEFAULT 7200                                 |
