...
| account_pid   | 上级账户       | 字符串   | 当前账户验证密码的方式为PID时候,可使用上级账户验证  | int(11)                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| organization  | 机构域         | 字符串   |                                                     | varchar(255)                                         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| role_id       | 角色标识       | 数值     | 如果不为空,表示账户和角色已绑定                     | int(11), fk_account_role->user_role.id                    |
...
| uid           | 用户唯一标识   | 字符串   | 由第三方系统提供的用户唯一标识                      | varchar(64), idx_user_name                           |
| status        | 状态           | 数值     | 1:启用 0:禁用 2: 未激活                             | tinyint(4) DEFAULT 1                                 |
...
| ------------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| id            | 唯一标识       | 数值     |                                                     | int(11) NOT NULL AUTO_INCREMENT, primary             |
| unionid       | 用户唯一标识   | 字符串   | 由第三方系统提供的用户唯一标识                      | varchar(255), udx_user_union_t_kid                   |
| unionid_type  | 验证方式       | 字符串   | 人归一时，验证用户归一方式                          | varchar(64), udx_user_union_t_kid                    |
...
| ckid          | 应用唯一标识   | 字符串   |                                                     | varchar(64), udx_user_client_kid, fk_user_client_kid->oauth2_client.kid |
| unionid       | 用户唯一标识   | 字符串   | 由第三方系统提供的用户唯一标识                      | varchar(255)                                         |
| unionid_type  | 验证方式       | 字符串   | 人归一时，验证用户归一方式                          | varchar(64)                                          |
...
| ------------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| id            | 唯一标识       | 数值     |                                                     | int(11) NOT NULL AUTO_INCREMENT, primary             |
| type          | 标签类型       | 数值     | 1:用户 2:角色 3:资源 4:平台 5:客户端                | tinyint(4), idx_tag_system_type                      |
| belong        | 归属id         | 数值     |                                                     | int(11), idx_tag_system_belong                     |
| tag_id        | 标签           | 字符串   |                                                     | int(11), fk_tag_system_tag_id->tag_system.id       | 
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| creator       | 创建人         | 字符串   |                                                     | varchar(64)                                          |
| created_at    | 创建时间       | 时间格式 |                                                     | timestamp                                            |
| updated_at    | 更新时间       | 时间格式 |                                                     | timestamp                                            |
...
| id            | 唯一标识       | 数值     |                                                     | int(11) NOT NULL AUTO_INCREMENT, primary             |
| type          | 标签类型       | 数值     | 1:用户 2:角色 3:资源 4:平台 5:客户端                | tinyint(4), idx_tag_system_type                      |
| belong        | 归属id         | 数值     |                                                     | int(11), idx_tag_custom_belong                       |
...
| ------------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| id            | 唯一标识       | 数值     |                                                     | int(11) NOT NULL AUTO_INCREMENT, primary             |
| fo_id         | 发送消息       | 字符串   |                                                     | int(64), fk_u_msg_fo_id->user.id                     |
