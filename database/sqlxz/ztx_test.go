...
func TestCreateUpdateSQLByNamed(t *testing.T) {
	...
	sql, pas, err := CreateUpdateSQLByNamed(TableIdxColumn{IDCol: "id", IDVal: 1}, o2a, nil, nil)
...
func TestCreateUpdateSQLByNamedSkipNil(t *testing.T) {
	...
	sql, pas, err := CreateUpdateSQLByNamedAndSkipNil(TableIdxColumn{IDCol: "id", IDVal: 1}, &o2a)
...
func TestCreateUpdateSQLByNamedSkipNilAndSet(t *testing.T) {
	...
	sql, pas, err := CreateUpdateSQLByNamedAndSkipNilAndSet(TableIdxColumn{IDCol: "id", IDVal: "1"}, &o2a)
