...
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| org_cod       | 租户标识       | 字符串   | 如果不为空,表示账户和租户绑定                       | varchar(64), udx_account,fk_account_org_cod->tenant.code |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| custom_id     | 唯一标识       | 字符串   | 账户自定义id                                        | varchar(255)                                         |
...
| org_cod       | 租户标识       | 字符串   | 为机构提供独立的签发令牌                            | varchar(64), fk_web_token_org_cod->tenant.code       |
...
| ------------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| status        | 状态           | 数值     | 1:启用 0:禁用 2:未激活(备用）3:删除                 | tinyint(4) DEFAULT 1                                 |
...
| org_cod       | 租户标识       | 数值     | 冗余字段， 和角色org_cod相同                        | varchar(64), fk_role_role_org_cod->tenant.code       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| creator       | 创建人         | 字符串   |                                                     | varchar(64)                                          |
| created_at    | 创建时间       | 时间格式 |                                                     | timestamp                                            |
| updated_at    | 更新时间       | 时间格式 |                                                     | timestamp                                            |
...
| org           | 组织标识       | 字符串   | 角色归属的组织， 1表示平台                          | varchar(64),          idx_policy_model_org           |
| ------------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| name          | 策略模型       | 字符串   |                                                     | varchar(64)                                          |
| statement     | 声明           | 字符串   |                                                     | varchar(4096)                                        |
| description   | 描述           | 字符串   |                                                     | varchar(255)                                         |
| status        | 状态           | 数值     | 1:启用 0:禁用 2:未激活                              | tinyint(4) DEFAULT 2                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| creator       | 创建人         | 字符串   |                                                     | varchar(64)                                          |
| created_at    | 创建时间       | 时间格式 |                                                     | timestamp                                            |
| updated_at    | 更新时间       | 时间格式 |                                                     | timestamp                                            |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| token_kid     | 当前使用的令牌 | 字符串   | 当前活跃的令牌                                      | varchar(255)                                         |
